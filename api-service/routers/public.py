...
from services.images import make_cover_svg, make_page_svg, read_image_file
...
def comics(category: str | None = None, keyword: str | None = None, sort: str = "updated", page: int = 1, page_size: int = 12):
    ...
    return ok({"items": [to_comic(r) for r in rows], "total": total, "page": page, "pageSize": page_size})
